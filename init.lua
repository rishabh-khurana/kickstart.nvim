...
require('lazy').setup({
  ...
  --   ---@type avante.Config
  --   opts = {
  --     provider = 'atlopenai', -- Changed to use gemini as default
  --     providers = {
  --       -- Google Gemini provider
  --       -- Keep your existing atlassian openAI provider as well
  --       atlopenai = {
  --         __inherited_from = 'openai',
  --         endpoint = 'https://ai-gateway.sgw.prod.atl-paas.net/v1/openai/v1/chat/completions',
  --         api_key_name = '',
  ...
  --             ['X-Atlassian-UseCaseId'] = 'avante-nvim',
  ...
  --           return {
  --             url = 'https://ai-gateway.sgw.prod.atl-paas.net/v1/openai/v1/chat/completions',
  --             headers = headers,
